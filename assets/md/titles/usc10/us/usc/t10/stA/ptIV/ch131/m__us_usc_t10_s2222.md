...
         the appropriate pre-certification authority for the covered defense business system program has determined that—
...
         The Secretary of Defense shall delegate responsibility and accountability for the defense business enterprise architecture content, including unambiguous definitions of functional processes, business rules, and standards, as follows:
...
         An information infrastructure that, at a minimum, would enable the Department of Defense to—
...
         For purposes of subsections (a) and (g), the appropriate pre-certification authority for a defense business system program is as follows:
...
         For purposes of subsection (g), the appropriate senior official of the Department of Defense for the functions and activities supported by a covered defense business system is as follows:
...
         The review of defense business systems programs under the investment management process shall include the following:
...
        (3) The term “enterprise architecture” has the meaning given that term in [section 3601(4) of title 44][/us/usc/t44/s3601/4].
