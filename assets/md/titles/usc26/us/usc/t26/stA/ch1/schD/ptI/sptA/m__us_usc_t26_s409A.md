...
    (b) __Rules relating to funding__ 
...
                (i) any period during which the plan is in at-risk status (as defined in section 430(i));  <sup>\[1\]</sup>  <sup><sup> 1 So in original. The semicolon probably should be a comma. </sup></sup> 
